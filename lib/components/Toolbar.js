...
var Toolbar = (_temp = _class = function (_Component) {
  ...
  _createClass(Toolbar, [{
    ...
    value: function setBarPosition() {
      ...
      var shouldUpdatePosition = !this.state.position || this.state.position.bottom !== newState.position.bottom || this.state.position.left !== newState.position.left || this.state.show !== newState.show;
    ...
    value: function componentDidUpdate() {
      var currentBlock = (0, _utils.getSelectedBlockElement)();
      var editorContainsSelection = this.props.editor.contains(currentBlock);
      var isCollapsed = this.props.editorState.getSelection().isCollapsed();
      var shouldShow = editorContainsSelection && !isCollapsed;
